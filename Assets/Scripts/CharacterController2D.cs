...
public class CharacterController2D : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (!m_Cooldown && m_Grounded && (m_Rigidbody2D.velocity.x > -.6f && m_Rigidbody2D.velocity.x < .6f) && (m_Rigidbody2D.velocity.y > -.2f && m_Rigidbody2D.velocity.y < .2f))
